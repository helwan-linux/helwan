...
# 🧰 Official Helwan Linux Ecosystem

🚀 **Core Helwan Packages (The Heart of Helwan)**

| Tool Name           | Description                                                    |
| ------------------- | -------------------------------------------------------------- |
| **hpm**             | Human-friendly Package Manager with natural language chaining. |
| **momo**            | Smart TUI system diagnostics and performance reports.          |
| **hel-sync**        | Zero-App PC-Mobile sync (Files, Clipboard, Remote Control).    |
| **hel-welcome-app** | First-time user guide, kernel management, and system cleaner.  |
| **hel-ai-gate**     | Lightweight bridge to AI assistant services.                   |
| **helfetch-ng**     | Enhanced system information fetch tool (The Helwan way).       |
| **hel-store**       | Minimalist GUI App Store for fast software installation.       |
| **hel-terminal**    | Customizable terminal emulator (Developer Edition).            |
| **hel-process**     | Graphical task manager and system resource monitor.            |
| **hel-web-server**  | Local development server with an easy-to-use GUI.              |
| **helufw**          | Simple GUI for managing firewall (UFW) configurations.         |
| **hel-stream**      | Local network media streaming and sharing tool.                |
...
| Tool Name           | Description                                               |
| ------------------- | --------------------------------------------------------- |
| **hel-builder**     | Tool to create, edit, and manage PKGBUILD files.          |
| **hel-iso-signer**  | Security utility for signing and verifying ISO images.    |
| **hel-netfix**      | One-click graphical network and system repair tool.       |
| **hel-sec-audit**   | Quick security scanner for system vulnerabilities.        |
| **hel-diagram**     | Lightweight diagram and flowchart creator for developers. |
| **hel-text-editor** | Fast, clean, and lightweight code and text editor.        |
| **hel-tutorial**    | Interactive Linux tutorials designed for beginners.       |
| **hel-markdown**    | Simple markdown editor for documentation and notes.       |
| **hel-usb-writer**  | Reliable tool to burn ISO images to USB drives.           |
| **hel-insight**     | Statistical analysis tool for CSV and Excel data files.   |

---

🎮 **Helwan Games (Built-in Fun)**

| Game Name           | Description                                    |
| ------------------- | ---------------------------------------------- |
| **hel-blocks**      | Classic and addictive Tetris-style block game. |
| **hel-mycar**       | 2D Top-down racing and car simulation game.    |
| **hel-space-fight** | Retro space arcade shooter with Helwan spirit. |
---
